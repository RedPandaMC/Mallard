...
import { evalCondition, evalSimpleCondition, evalRule, compileConditions, resolveVar, JsonConditionSchema } from '../../src/client_extension/domain/expr/jsonCondition';
import type { JsonCondition, JsonOperand } from '../../src/client_extension/domain/types';
